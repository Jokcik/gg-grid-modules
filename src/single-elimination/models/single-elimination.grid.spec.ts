...
//     it('stageId 0', () => {
//       const grid = new SingleEliminationGrid();
//       grid._stages = [new Stage(), new Stage(), new Stage()];
//       grid._stages[0].matches = [new Match(), new Match(), new Match()];
//       grid._stages[1].matches = [new Match(), new Match()];
//       grid._stages[2].matches = [new Match()];
//
//       grid._stages[0].matches[0].player1 = '1';
//       grid._stages[0].matches[0].player2 = EMPTY_PLAYER;
//       grid._stages[0].matches[1].player1 = '2';
//       grid._stages[0].matches[1].player2 = '3';
//       grid._stages[0].matches[2].player1 = '5';
//       grid._stages[0].matches[2].player2 = EMPTY_PLAYER;
//
//       grid.winEmptyPlayers(0);
//
//       expect(grid._stages[1].matches[0].player1).toBe('1');
//       expect(grid._stages[1].matches[0].player2).not.toBeDefined();
//       expect(grid._stages[1].matches[1].player1).toBe('5');
//       expect(grid._stages[1].matches[1].player2).not.toBeDefined();
//     });
//   });
//
...
//       const grid = new SingleEliminationGrid();
//       grid._stages = [new Stage(), new Stage(), new Stage()];
//       grid._stages[0].matches = [new Match(), new Match(), new Match(), new Match()];
//       grid._stages[1].matches = [new Match(), new Match()];
//       grid._stages[2].matches = [new Match()];
//
//       grid._stages[0].matches[0].player1 = '1';
//       grid._stages[0].matches[0].player2 = '2';
//       grid._stages[0].matches[1].player1 = '3';
//       grid._stages[0].matches[1].player2 = '4';
//       grid._stages[0].matches[2].player1 = '5';
//       grid._stages[0].matches[2].player2 = '6';
//       grid._stages[0].matches[3].player1 = '7';
//       grid._stages[0].matches[3].player2 = '8';
//
//       grid._stages[1].matches[0].player1 = '1';
//       grid._stages[1].matches[0].player2 = '3';
//       grid._stages[1].matches[1].player1 = '5';
//       grid._stages[1].matches[1].player2 = '7';
//
//       grid._stages[2].matches[0].player1 = '1';
//       grid._stages[2].matches[0].player2 = '5';
//
//       grid.cancelResultMatch(0, 1);
//
//       expect(grid._stages[1].matches[0].player1).toBeDefined();
//       expect(grid._stages[1].matches[0].player2).not.toBeDefined();
//       expect(grid._stages[2].matches[0].player1).not.toBeDefined();
//       expect(grid._stages[2].matches[0].player2).toBeDefined();
//     });
//   });
//
...
//     it('add Third', () => {
//       const grid = new SingleEliminationGrid();
//       grid._stages = [new Stage(), new Stage()];
//       grid._stages[0].matches = [new Match(), new Match()];
//       grid._stages[1].matches = [new Match()];
//
//       grid.addThird();
//
//       expect(grid._stages[1].matches[1]).toBeDefined();
//       expect(grid._stages[1].matches[1].isThird).toBe(true);
//     });
//
//     it('add SuperFinal', () => {
//       const grid = new SingleEliminationGrid();
...
//       grid.addSuperFinal();
//
//       expect(grid._stages[2].matches[0]).toBeDefined();
//       expect(grid._stages[2].matches[0].isThird).not.toBeTruthy();
//     });
//   });
//
...
//
//       expect(grid._stages[0].matches[0].closed).toBe(true);
//       expect(grid._stages[1].matches[0].player1).toBe('1');
//       expect(grid._stages[1].matches[0].player2).toBe('4');
//     });
//
...
//       grid.winPlayerInMatch(0, 0, '1', 1);
//
//       expect(grid._stages[0].matches[0].closed).not.toBeTruthy();
//       expect(grid._stages[1].matches[0].player1).not.toBeDefined();
//     });
//
...
//       grid._stages = [new Stage(), new Stage()];
//       grid._stages[0].matches = [new Match(), new Match()];
//       grid._stages[1].matches = [new Match(), third];
//
//       grid._stages[0].matches[0].player1 = '1';
//       grid._stages[0].matches[0].player2 = '2';
//       grid._stages[0].matches[1].player1 = '3';
...
//
//       expect(grid._stages[1].matches[0].player1).toBe('1');
//       expect(grid._stages[1].matches[0].player2).toBe('3');
//       expect(grid._stages[1].matches[1].player1).toBe('2');
//       expect(grid._stages[1].matches[1].player2).toBe('4');
//     });
//   });
//
