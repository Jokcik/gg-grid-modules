...
export class DoubleEliminationController {
  public generateGrid(players: string[]): DoubleEliminationGrid {
    ...
    console.log(grid.upGrid.stages[0].matches);
    console.log('0------------------------------------------------------------------------------------------------------------------');
    console.log(grid.upGrid.stages[1].matches);
    console.log('1------------------------------------------------------------------------------------------------------------------');
    console.log(grid.upGrid.stages[2].matches);
    console.log('2------------------------------------------------------------------------------------------------------------------');
    console.log(grid.upGrid.stages[3].matches);
    console.log('3------------------------------------------------------------------------------------------------------------------');
    console.log(grid.upGrid.stages[4].matches);
    console.log('4------------------------------------------------------------------------------------------------------------------');

    console.log('=================================================================================================================');

    console.log(grid.downGrid.stages[0].matches);
    console.log('0------------------------------------------------------------------------------------------------------------------');
    console.log(grid.downGrid.stages[1].matches);
    console.log('1------------------------------------------------------------------------------------------------------------------');
    console.log(grid.downGrid.stages[2].matches);
    console.log('2------------------------------------------------------------------------------------------------------------------');
    console.log(grid.downGrid.stages[3].matches);
    console.log('3------------------------------------------------------------------------------------------------------------------');
    console.log(grid.downGrid.stages[4].matches);
    console.log('4------------------------------------------------------------------------------------------------------------------');
    console.log(grid.downGrid.stages[5].matches);
    console.log('5------------------------------------------------------------------------------------------------------------------');
