...
//
//     const startStage = grid.upGrid._stages[0];
...
//
//     if (stageId % 2 === 1) {
//       downMatchId = this.downGrid._stages[downStageId].matches.length - downMatchId - 1;
//     }
//
//     const downMatch = this.downGrid._stages[downStageId].matches[downMatchId];
...
//     const match = this.downGrid._stages[stageId].matches[matchId];
...
//
//     const nextStage = this.downGrid._stages[stageId + 1];
//     if (!nextStage) {
//       this.upGrid._stages[this.upGrid._stages.length - 1].matches[0].player2 = match.stat.win;
//       return match;
//     }
//
//     if (stageId % 2 === 0) {
